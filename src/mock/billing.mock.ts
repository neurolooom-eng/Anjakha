...
export const mockInvoices: Invoice[] = [
  {
    ...
    date: relativeDate(0), category: 'OPD',
    items: [
  ...
  },
  {
    ...
    date: relativeDate(-1), category: 'IPD',
    items: [
  ...
  },
  {
    ...
    date: relativeDate(0), category: 'Pharmacy',
    items: [
...
export const mockPayments: Payment[] = [
  { id: 'pay_1', invoiceId: 'inv_1', invoiceNumber: 'INV-2026-3001', patientName: 'Ramesh Kulkarni', date: relativeDate(0), amount: 1475, mode: 'UPI', referenceNo: 'UPI2607130001', ...seedAudit(0) },
  { id: 'pay_2', invoiceId: 'inv_2', invoiceNumber: 'INV-2026-3002', patientName: 'Vikram Singh', date: relativeDate(-1), amount: 10000, mode: 'Insurance', referenceNo: 'TPA-CASHLESS-778', ...seedAudit(1) },
  { id: 'pay_3', invoiceId: 'inv_3', invoiceNumber: 'INV-2026-3003', patientName: 'Fatima Ansari', date: relativeDate(0), amount: 120.96, mode: 'Cash', ...seedAudit(0) },
]
