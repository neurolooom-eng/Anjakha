...
export const mockConsultations: Consultation[] = [
  {
    ...
    date: '2026-07-13', department: 'Cardiology',
    ...
    followUpDate: '2026-07-27', status: 'Finalized', ...seedAudit(0),
  },
  {
    id: 'con_2', patientId: 'pat_3', patientName: 'Arjun Reddy', doctorName: 'Dr. Rohit Verma',
    date: '2026-07-13', department: 'Orthopaedics',
  ...
  },
  {
    ...
    date: '2026-07-13', department: 'General Medicine',
  ...
  },
  {
    ...
    date: '2026-07-12', department: 'ENT',
...
export const mockPrescriptions: Prescription[] = [
  {
    ...
    doctorName: 'Dr. Rohit Verma', date: '2026-07-13',
    items: [
  ...
  },
  {
    ...
    doctorName: 'Dr. Sanjay Bhat', date: '2026-07-13',
    items: [
