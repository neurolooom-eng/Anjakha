...
export const router = createHashRouter([
  {
    ...
    children: [
      ...
      { path: 'doctors/console', element: <RequirePermission permission="doctors:view"><MyConsoleTab /></RequirePermission> },
      { path: 'doctors/my-schedule', element: <RequirePermission permission="doctors:view"><MyScheduleTab /></RequirePermission> },
